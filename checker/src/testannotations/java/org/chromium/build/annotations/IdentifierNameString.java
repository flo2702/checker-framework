...
// https://source.chromium.org/chromium/chromium/src/+/main:build/android/java/src/org/chromium/build/annotations/IdentifierNameString.java
 ...
 *
 * <ul>
 *   <li>This only obfuscates the string, it does not actually check that the class exists.
 *   <li>If a field has this annotation, it must be non-final, otherwise javac will inline the
 *       constant and R8 won't obfuscate it.
 *   <li>Any field/method must be assigned/called with a String literal or a variable R8 can easily
