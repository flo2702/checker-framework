...
/**
 * An abstract transfer function for the freedom-before-commitment type system that extends {@link
 * CFAbstractTransfer} and tracks {@link InitializationAbstractStore}s. In addition to the features
 * of {@link CFAbstractTransfer}, this transfer function also tracks which fields of the current
 * class ('self' receiver) have been initialized.
 *
 ...
 */
public abstract class InitializationAbstractTransfer<
    ...
    @Override
    public TransferResult<Value, Store> visitAssignment(
            AssignmentNode n, TransferInput<Value, Store> in) {
        TransferResult<Value, Store> result = super.visitAssignment(n, in);
    ...
    @Override
    public TransferResult<Value, Store> visitMethodInvocation(
            MethodInvocationNode n, TransferInput<Value, Store> in) {
        TransferResult<Value, Store> result = super.visitMethodInvocation(n, in);
