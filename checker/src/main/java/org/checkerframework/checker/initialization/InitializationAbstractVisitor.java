...
/**
 * An implementation of an abstract visitor for the freedom-before-commitment type-system.
 *
...
public abstract class InitializationAbstractVisitor<
    ...
    /**
     * Create an InitializationAbstractVisitor.
     *
     * @param checker the initialization checker
     */
    public InitializationAbstractVisitor(BaseTypeChecker checker) {
        super(checker);
