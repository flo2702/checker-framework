...
\item
  ...
  -AassumeKeyFor -AjspecifyUnrecognizedLocations}.  Each of those is an on/off flag with
  no negative form, so there is currently no way to enable this mode but turn one of
  them back off.
